...
class BeerControllerTest {
    ...
    void getBeerById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}" , UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer", pathParameters(parameterWithName("beerId")
                        .description("UUID of the desired beeer to get")),
                        requestParameters(
                                parameterWithName("isCold").description("Bear query param either hot or cold")
                        ),
                        responseFields(
